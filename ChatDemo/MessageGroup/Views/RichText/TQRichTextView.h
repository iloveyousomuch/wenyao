...
@property (nonatomic,readonly)      NSMutableArray *richPhoneRunsArray;
@property (nonatomic,readonly)      NSMutableArray *richEmailRunsArray;
@property (nonatomic, readonly)     NSMutableArray *richUrlRunsArray;
