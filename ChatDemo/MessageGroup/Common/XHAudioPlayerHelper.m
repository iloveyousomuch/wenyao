...
+ (void)playAlarmAudio
{
    ...
    BOOL alarmAudio = [[userDefaults objectForKey:ALARM_VOICE_NOTIFICATION] boolValue];
    if(alarmAudio){
    ...
    BOOL vibration = [[userDefaults objectForKey:ALARM_VIBRATION_NOTIFICATION] boolValue];
    if(vibration)
