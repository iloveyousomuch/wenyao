...
- (BOOL)enableBackgroundingOnSocketWithCaveat:(BOOL)caveat
{
    ...
    r1 = YES;//CFReadStreamSetProperty(readStream, kCFStreamNetworkServiceType, kCFStreamNetworkServiceTypeVoIP);
    r2 = YES;//CFWriteStreamSetProperty(writeStream, kCFStreamNetworkServiceType, kCFStreamNetworkServiceTypeVoIP);
