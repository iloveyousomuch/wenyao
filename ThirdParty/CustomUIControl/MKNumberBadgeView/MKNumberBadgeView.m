...
{
    _value = inValue;
    self.hidden = ![[((UINavigationController *)app.tabBarController.viewControllers[0]).viewControllers lastObject] isKindOfClass:[NewHomePageViewController class]] || (self.hideWhenZero && _value == 0);
